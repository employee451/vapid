...
module.exports = (BaseDirective) => {
   ...
   */
  class InkaWorkshopParticipantsDirective extends BaseDirective {
    /**
     * @static
     *
    ...
    input() {
      ...
      return `
      <div id="inkaWorkshopParticipants"></div>
      <style>
        #kursister table {
      ...
      <script>
        ...
        var kurserPromise = new Promise((resolve, reject) => {
          ...
          fetch('https://api.compassionpsykologerne.dk/api/kurser', { credentials: 'same-origin' })
  ...
  return InkaWorkshopParticipantsDirective;
};
